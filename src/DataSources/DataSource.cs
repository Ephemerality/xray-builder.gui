...
namespace XRayBuilderGUI.DataSources
{
    public abstract class DataSource
    {
        ...
        public virtual void GetExtras(BookInfo curBook, IProgress<Tuple<int, int>> progress = null) { }
        ...
        public virtual List<Tuple<string, int>> GetNotableClips(string url, HtmlDocument srcDoc = null, IProgress<Tuple<int, int>> progress = null) { return new List<Tuple<string, int>>(); }
    }
}
