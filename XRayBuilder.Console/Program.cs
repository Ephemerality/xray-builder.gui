    ...
    internal static class Program
    {
        ...
        private static BaseOptions ConfigureBaseOptions(CommandLineApplication cli)
        {
            ...
            return new BaseOptions
            {
                ...
                BaseOutputDirectory = cli.Option("-o|--output", "Specify the base output directory. Default is /out.",
                    CommandOptionType.SingleValue),
                OutputToSidecar = cli.Option("--sidecar",
                    "Output to a sidecar directory within the output directory, eg Book.sdr",
                    CommandOptionType.NoValue),
                UseSubdirectories = cli.Option("--subdir",
                    "Use author/title subdirectories within the output directory.", CommandOptionType.NoValue),
                FixAsin = cli.Option("--fixasin",
                    "When specified, invalid ASINs will be searched on Amazon and fixed, if possible. (This will modify the book meaning it will need to be re-copied to your Kindle device) -- THIS FEATURE IS EXPERIMENTAL AND COULD DESTROY YOUR BOOK",
                    CommandOptionType.NoValue),
                AmazonTld = cli.Option("--tld", "Amazon TLD, eg com, co,uk, de, etc. Default is com.",
                    CommandOptionType.SingleValue)
            };
        }
